...
box_height = 300  # mm box height (30cm)
extrude_height = 300  # mm extrusion height upward
extrude_start_z = 5  # mm extrusion start height

svg_to_mm_scale = 1  # 1 SVG unit == 1 mm, adjust if needed

# ==== Step 1: Convert SVG → DXF with scaling ====
paths, _ = svg2paths(svg_path)
doc = ezdxf.new(dxfversion='R2010')
msp = doc.modelspace()
...
result = box.intersect(dxf_shape)
